...
<head>
    ...
    .navbar {
        ...
        box-shadow: 0 2px 10px rgb(14, 126, 29);
    ...
    .login-card {
        ...
        border-radius: 15px;
        overflow: hidden;
        box-shadow: 0 10px 30pxrgb(14, 126, 29);
                ...
                <form>
                    ...
                    <div class="social-login">
                        <button type="button" class="btn btn-outline-secondary w-100">
                            <i class="fab fa-google me-2" style="color:rgb(172, 248, 21);"></i> Google
                        </button>
                        <button type="button" class="btn btn-outline-primary w-100">
                            <i class="fab fa-facebook-f me-2" style="color:rgb(145, 189, 247);"></i> Facebook
                        </button>
                    </div>
                </form>
